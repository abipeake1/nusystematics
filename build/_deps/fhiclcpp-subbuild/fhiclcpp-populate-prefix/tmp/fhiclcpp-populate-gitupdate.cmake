...
execute_process(
  COMMAND "/usr/bin/git" show-ref "23.09"
  WORKING_DIRECTORY "/root/software/newsystematics_new/build/_deps/fhiclcpp-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("23.09" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/23.09")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/root/software/newsystematics_new/build/_deps/fhiclcpp-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/root/software/newsystematics_new/build/_deps/fhiclcpp-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
